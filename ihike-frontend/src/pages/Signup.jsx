...
// Re-using the GoogleIcon from the login page
const GoogleIcon = () => (
...
const SignupPage = () => {
  ...
  return (
    <div 
      ...
      style={{ backgroundImage: "url('https://placehold.co/1920x1080/1F2937/FFFFFF?text=Join+iHike')" }}
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 mt-2">Create your account to start exploring.</p>
        </div>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex items-start mt-6">
            <input id="terms" type="checkbox" className="h-4 w-4 mt-1 rounded border-gray-300 text-green-600 focus:ring-green-500 bg-white/30" />
          ...
          <button 
            type="submit" 
            className="w-full bg-green-600 text-white font-bold py-3 rounded-lg mt-6 hover:bg-green-700 transition-all transform hover:scale-105"
          >
            Create Account
          </button>
        </form>
